								...
								<div class="modal-dialog modal-lg">
								  <div class="modal-content">
									...
									<div class="modal-body">
									  <button type="button" class="btn btn-primary">Toán Học</button>&nbsp;
											<button type="button" class="btn btn-primary">Vật Lý </button>&nbsp;
											<button type="button" class="btn btn-primary">Sinh Học </button>&nbsp;
											<button type="button" class="btn btn-primary">Hóa Học </button>&nbsp;
								...
								<div class="modal-dialog modal-lg">
								  <div class="modal-content">
									...
									<div class="modal-body" >
											...
											<button type="button" class="btn btn-primary">Khối A </button>&nbsp;
