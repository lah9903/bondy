    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Forms Sửa Đề Toán</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                     <form action="{{ route('math.update',['id'=>$math->id]) }}" method="POST" >
                                        <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
                                            <div class="form-group">
                                               ...
                                               <input name="_method" type="hidden" value="PATCH">
                                                ...
                                                <label @if ($errors->first('question')) style="color:red" @endif >Câu hỏi</label>
                                                    ...
                                                    <input @if ($errors->first('question')) style="border-color:red" @endif type="text" name="question" class="form-control" id="exampleInputPassword1" placeholder="" value=" {!! $math->question !!} ">
                                            ...
                                            <div class="form-group">
                                                <label @if ($errors->first('dapanA')) style="color:red" @endif >Đáp án A</label>
                                                    ...
                                                    <input @if ($errors->first('dapanA')) style="border-color:red" @endif type="text" name="dapanA" class="form-control" id="exampleInputPassword1" placeholder="" value=" {!! $math->dapanA !!}">
                                            ...
                                            <div class="form-group">
                                                <label @if ($errors->first('dapanB')) style="color:red" @endif >Đáp án B</label>
                                                    ...
                                                    <input @if ($errors->first('dapanB')) style="border-color:red" @endif type="text" name="dapanB" class="form-control" id="exampleInputPassword1" placeholder="" value=" {!! $math->dapanB !!}" >
                                            ...
                                            <div class="form-group">
                                                <label @if ($errors->first('dapanC')) style="color:red" @endif >Đáp án C</label>
                                                    ...
                                                    <input @if ($errors->first('dapanC')) style="border-color:red" @endif type="text" name="dapanC" class="form-control" id="exampleInputPassword1" placeholder="" value=" {!! $math->dapanC !!}" >
                                            ...
                                            <div class="form-group">
                                                <label @if ($errors->first('dapanD')) style="color:red" @endif >Đáp án D</label>
                                                    ...
                                                    <input @if ($errors->first('dapanD')) style="border-color:red" @endif type="text" name="dapanD" class="form-control" id="exampleInputPassword1" placeholder="" value=" {!! $math->dapanD !!}" >
                                            ...
                                            <div class="form-group">
                                                <label @if ($errors->first('dung')) style="color:red" @endif >Đáp án đúng</label>
                                                   ...
                                                   <select  @if ($errors->first('dung')) style="border-color:red" @endif type="text" name="dung" class="form-control" id="exampleInputPassword1" placeholder="" value=" {!! $math->dung !!}" >
                                            ...
                                            <div  class="form-group">
                                                <label @if ($errors->first('role')) style="color:red" @endif >Độ khó</label>
                                                    ...
                                                    <select @if ($errors->first('role')) style="border-color:red" @endif type="text" name="role" class="form-control" id="exampleInputPassword1" placeholder="" value=" {!! $math->role !!}" >
